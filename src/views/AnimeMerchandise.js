...
export default function AnimeMerchandise() {
  const { id } = DataMerchandise
      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active carousel-shop">
            <img src="https://cdn.shopify.com/s/files/1/0610/0883/8824/files/OTAKU_97b19560-5ed2-49ac-83f7-f6edfc2ad7a6.png" />

            <div class="container">
              <div class="carousel-caption text-start">
                <h1>Merchandise</h1>
                <p>
                  Flex on your spouse with some anime merchandise, its worth
                  more then gold!
                </p>
                <p>
