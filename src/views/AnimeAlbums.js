      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active carousel-shop">
            <img src="https://pbs.twimg.com/media/ChSkQrmUUAQyzjG?format=jpg&name=large" />

            <div class="container">
              <div class="carousel-caption text-start">
                <h1 className="recent-text4">Albums</h1>
                <p className="recent-text4">
                  Listen to your favorite soundtracks, whenever and wherever you
                  want!
                </p>
                <p>
