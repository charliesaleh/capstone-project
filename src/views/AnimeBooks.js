...
export default function AnimeBooks() {
  const { id } = DataBooks
      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active carousel-shop">
            <img src="https://dw9to29mmj727.cloudfront.net/promo/2016/6028-SJsummer_SJsales_2000x800_jpg" />

            <div class="container">
              <div class="carousel-caption text-start">
                <h1 className="recent-text4">Light Novels/ Mangas/ Manwhas</h1>
                <p className="recent-text4">
                  Impatient for the next episode, get ahead by reading!
                </p>
                <p>
