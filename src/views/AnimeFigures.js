      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active carousel-shop">
            <img src="https://kurogami.com/min/img/paginas/banner-promesa-kurogami_3.jpg" />

            <div class="container">
              <div class="carousel-caption text-start">
                <h1>Light Novels/ Mangas/ Manwhas</h1>
                <p>Impatient for the next episode, get ahead by reading!</p>
                <p>
